...
**Status:** Version 0.3.2, erste vorsichtig freigegebene Version.
...
```text
https://github.com/herdan75/LoxBerry-Plugin-HostBackup/releases/download/v0.3.2/LoxBerryHostBackup_0.3.2.zip
```

Lokales Paket nach dem Build:

```text
LoxBerryHostBackup_0.3.2.zip
```
...
- `main`: aktueller freigegebener Stand 0.3.2
