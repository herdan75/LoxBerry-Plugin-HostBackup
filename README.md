...
**Status:** Version 0.5.2, Release mit asynchronem Import/Export.
...
```text
https://github.com/herdan75/LoxBerry-Plugin-HostBackup/releases/download/v0.5.2/LoxBerryHostBackup_0.5.2.zip
```
