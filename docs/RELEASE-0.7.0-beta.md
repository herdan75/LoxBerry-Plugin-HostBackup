...
Historisches Dokument. Das aktuelle reguläre Release auf `main` ist
[Version 1.0.0](RELEASE-1.0.0.md); die nachfolgenden Angaben beschreiben den damaligen Stand.
